        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-dark">
                    <div class="p-4 m-3">
                        <img src="{{asset ('assets/img/soju.jpg')}}" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">E - SOJU</span></h4>
                        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                            @csrf
                            <div class="form-group">
                                <label for="ntag">NTAG</label>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; UKM Gerakan Pramuka Universitas Jember. <br> Made with 💙 by Renanta
                        </div>
                    </div>
                </div>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                ...
                                <h5 class="font-weight-normal text-muted-transparent">Website Informasi UKM Gerakan Pramuka Universitas Jember</h5>
                            </div>
                        </div>
                    </div>
                </div>
